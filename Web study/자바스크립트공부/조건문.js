...
// if 를 세번 쓰는 것보다 저렇게 하는 것이 컴퓨터가 일을 '덜' 한다.
...
//문제7. 첫번째수에 두번째수가 몇 번 들어있나 출력해보세요
//예: 123456789101112, 2라면 2번

//문제6. 세 숫자를 비교하여 가장 큰 숫자를 출력해보세요
let e=4;
let f=5;
let g=6;
...
//문제7. 문자열이 들어있는 변수에 "안녕"이 들어있으면 "안녕하세요"를 콘솔에 찍으세요
//문제 풀이방법 및 공부방법
//1.변수를 선언하고 문자열을 넣얼 수 있나?
...
// 90점대 = 수, 80점대 = 우, 70점대 = 미, 60점대 = 양, 60미만 = 가
